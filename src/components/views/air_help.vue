<template>
  <div class="airHelp" v-loading="loading">
    ...
    <div class="sheetPart">
      <template>
        <el-table ref="multipleTable" :data="tableData3" tooltip-effect="dark" style="width: 100%;">
          ...
          <el-table-column prop="resource" label="问题序号" show-overflow-tooltip></el-table-column>
          <el-table-column prop="creater" label="创建人" sortable show-overflow-tooltip></el-table-column>
          <el-table-column prop="creatDate" label="创建时间" sortable show-overflow-tooltip></el-table-column>
          <el-table-column prop="updater" label="更新人" sortable show-overflow-tooltip></el-table-column>
